    ...
    <article className="group">
      ...
      <StaggerGroup className="mt-5 flex items-start justify-between gap-6" stagger={0.06}>
        <div>
          ...
          <MotionItem><h3 className="editorial-title mt-3 text-2xl leading-tight text-ink transition-transform duration-500 group-hover:translate-y-[-2px]">{project.title}</h3></MotionItem>
