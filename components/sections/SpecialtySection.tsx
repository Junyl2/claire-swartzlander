            ...
            return (
              <Reveal key={item.title} delay={index * 0.06}>
                <article className="group h-full bg-white p-8 transition duration-500 hover:bg-paper md:p-10">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full border border-primary/40 text-primary transition duration-500 group-hover:border-primary group-hover:bg-primary group-hover:text-white">
                    <Icon className="h-5 w-5" />
                  </div>
                  <p className="ui-title mt-6 text-[11px] text-primary">{item.byline}</p>
